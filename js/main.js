...
// ==========================================
// 2. Data Fetching & Rendering Logic (Infinite Day Loop Enabled)
// ==========================================
...
// সপ্তাহের দিনগুলোর সঠিক সিকোয়েন্স
const daysSequence = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];

let routineData = {};
let currentSelectedDay = new Date().toLocaleString('en-us', { weekday: 'long' });
const actualToday = currentSelectedDay;

// নির্দিষ্ট ট্যাবকে স্ক্রিনের মাঝখানে (center) স্মুথলি নিয়ে যাওয়ার ফাংশন
...
// Day Tab active class setup & Blinking Dot Integration
dayTabs.forEach(tab => {
    const tabDay = tab.getAttribute('data-day');

    // ১. আজকের বারের পাশে গ্রিন ব্লিংকিং ডট যোগ করা
...
// অতিরিক্ত সুবিধা: আপনি চাইলে কিবোর্ডের অ্যারো বা মাউস স্ক্রোল দিয়েও দিনগুলো লুপ করাতে পারেন, 
// অথবা ট্যাপ করার সময় ইনফিনিট ফিল পাওয়ার জন্য নিচের অংশটুকু কাজ করবে।

// JSON theke directly data load kora
...
// Routine Show korar function (Optimized with DocumentFragment for Speed)
function displayRoutine() {
    ...
    // সেমিস্টার বা সেকশন বদলানোর সময় আজকের বা সিলেক্ট করা ট্যাবটি স্ক্রিনে ফোকাস রাখা
    const activeTab = Array.from(dayTabs).find(t => t.getAttribute('data-day') === currentSelectedDay);
    if (activeTab) {
        scrollTabIntoView(activeTab);
    }

    // মেমোরি ফাস্ট রাখার জন্য ফ্রেগমেন্ট ব্যবহার করা হয়েছে
    ...
    // সব কার্ড একসাথে একবারেই রেন্ডার হবে
